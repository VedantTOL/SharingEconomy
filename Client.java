    ...
    private static class buyerEditAccount extends JFrame {
        ...
        public buyerEditAccount(Buyer buyer) {
            ...
            editEmailButton.addActionListener(new ActionListener() {
                ...
                public void coreProcess(Buyer buyer) {
                    BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(dos));
                    try {
                        bw.write("changeAccount\n");
                        bw.flush();
                        bw.write(buyer.constructorString());
                        bw.write("\n");
                        bw.flush();
                    } catch (IOException e) {
                        throw new RuntimeException(e);
        ...
        public BuyerGUI(User user) {
            ...
            editAccountButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    buyerEditAccount buyerEditAccount = new buyerEditAccount(buyer);
                    buyerEditAccount.setVisible(true);
                }
            });
...
//                    }
    ...
    private static class sellerEditAccount extends JFrame {
        private JButton editEmailButton;
        private JButton editPasswordButton;
        private JButton previousPageButton;
        private Seller seller;

        public sellerEditAccount(Seller seller) {
            super("Edit Account");
            this.seller = seller;
            editEmailButton = new JButton("Enter new email");
            editPasswordButton = new JButton("Enter new password");
            ...
            editEmailButton.addActionListener(new ActionListener() {
                ...
                public void coreProcess(Seller seller) {
                    BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(dos));
                    try {
                        bw.write("changeAccount\n");
                        bw.flush();
                        bw.write(seller.constructorString());
                        bw.write("\n");
                        bw.flush();
                    } catch (IOException e) {
                        throw new RuntimeException(e);
    ...
    private static class SellerGUI extends JFrame {
        ...
        private Seller createSeller(User user) {
            Seller seller = new Seller(user.getUniqueIdentifier(), user.getEmail(), user.getPassword(), user.getName(),
                    user.getAge(), new ArrayList<Store>());
        ...
        public SellerGUI(User user) {
            ...
            statisticsButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        coreProcess(seller, buyerDatabase);
                ...
                public void coreProcess(Seller seller,  ArrayList<Buyer> buyerDatabase) throws DataFormatException, IOException {
                    seller.getSellerStatistics(buyerDatabase);
                }
            ...
            editAccountButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    Seller seller = createSeller(user);
                    sellerEditAccount sellerEditAccount = new sellerEditAccount(seller);
                    sellerEditAccount.setVisible(true);
    ...
    private static class editStoreProducts extends JFrame {
        ...
        public void coreProcess(Store store, Seller seller, ArrayList<Seller> database) {
            for (Store stores: seller.getStores()) {
                if (stores.getStoreName().equals(store)) {
                    seller.getStores().remove(stores);
                    seller.addStore(-1, store);
                }
            }

            for (Seller kl: database) {
                if (seller.getUniqueIdentifier() == kl.getUniqueIdentifier()) {
                    database.remove(kl);
                    database.add(seller);
                }
            }
        ...
        public editStoreProducts(Store store, Seller seller) {
            ...
            changeProductNameButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    ArrayList<Seller> sellerDb = requestSellerDatabase();
                    coreProcess(store, seller, sellerDb);
                }
